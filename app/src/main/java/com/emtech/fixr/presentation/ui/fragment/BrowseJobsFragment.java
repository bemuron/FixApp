 ...
 */
public class BrowseJobsFragment extends Fragment {
    ...
    public static BrowseJobsFragment newInstance(String param1, String param2) {
        BrowseJobsFragment fragment = new BrowseJobsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_browse_jobs, container, false);
        // Progress dialog
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Browse Jobs");
    }
