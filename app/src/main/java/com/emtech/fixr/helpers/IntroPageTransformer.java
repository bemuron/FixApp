...
import com.emtech.fixr.presentation.ui.activity.PaymentActivity;

public class IntroPageTransformer implements ViewPager2.PageTransformer {
    private static final String TAG = IntroPageTransformer.class.getSimpleName();
    @Override
    public void transformPage(@NonNull View page, float position) {
        Log.e(TAG,"Page id is"+page.getId());
